...
import { UserBookFormUnroutedComponent } from '../../book/user-book-form-unrouted/user-book-form-unrouted.component';
import { UserLoanFormUnroutedComponent } from '../user-loan-form-unrouted/user-loan-form-unrouted.component';
...
@Component({
  selector: 'app-user-loan-plist-unrouted',
  templateUrl: './user-loan-plist-unrouted.component.html',
  styleUrls: ['./user-loan-plist-unrouted.component.scss']
})
export class UserLoanPlistUnroutedComponent {
  @Input()
